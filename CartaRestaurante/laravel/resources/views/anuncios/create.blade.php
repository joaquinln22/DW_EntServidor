    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('anuncios.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="titulo" class="form-control" placeholder="Ej: Promoción especial" value="{{ old('titulo') }}" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Mensaje</label>
                <textarea name="mensaje" class="form-control" rows="3" placeholder="Escribe el mensaje del anuncio..." required>{{ old('mensaje') }}</textarea>
            </div>
            <div class="mb-3">
